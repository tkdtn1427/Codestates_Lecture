...
public class _37_radixSort {
    public static void main(String[] args) {
        int[] output = radixSort(new int[]{3,1,21,100,50,41});
        System.out.println(Arrays.toString(output));
//        System.out.println(output);
    }

//    static int[] radixSort(int[] arr) {
//        List<List<Integer>> rx = new ArrayList<>(List.of(new ArrayList<>(),new ArrayList<>(),new ArrayList<>(),
...
//                int remain = temp[j]/(int)(Math.pow(10,i))%10;
//                rx.get(remain).add(temp[j]);
//            }
////            System.out.println(rx);
//            for(List<Integer> tmp : rx){
//                for(int tmp2 : tmp){
//                    temp[idx++] = tmp2;
//                }
//                tmp.clear();
