...
//        int result = 0;
//        result = recur(total,coins, idx, result);
//        return result;
//    }
//
//    static int recur(int total, int[] coins, int idx, int result){
//        if(total == 0){
//            return result +1;
//        }
//        if(idx < 0){
//            return result;
//        }
//        int num = total/coins[idx];
//
//        for(int i=num; i>=0; i--){
//            int remain = total - coins[idx]*i;
//            result = recur(remain, coins, idx-1, result);
//        }
//
//        return result;
//    }
//==============================================================================
     ...
     static int makeChageFrom(int left, int idx, int[] coins, ArrayList<Integer[]> memo) {
