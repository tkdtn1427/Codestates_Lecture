...
public class _5_RSP {
    public static void main(String[] args) {
        ArrayList<String[]> show = rockPaperScissors(3);
        for(String[] show_ : show){
            System.out.println(Arrays.toString(show_));
        }
    }

//    static ArrayList<String[]> rockPaperScissors(int rounds){
//        ArrayList<String[] > result = new ArrayList<String[]>();
//        String[] temp = new String[rounds];
//        return Case_(rounds,result,temp);
//    }
//
//    static ArrayList<String[]> Case_(int rounds, ArrayList<String[]> result,String[] temp){
//        ArrayList<String> rsp = new ArrayList<String>(Arrays.asList("rock","paper","scissors"));
//        int index = temp.length -rounds;
//        rounds -= 1;
//        for(String str : rsp){
//            temp[index] = str;
//            if(rounds == 0){
//                String[] input = Arrays.copyOfRange(temp,0,temp.length);
//                result.add(input);
//                continue;
//            }
//            result = Case_(rounds,result,temp);
//        }
//
//        return result;
//    }
//========================================================================
    ...
    static ArrayList<String[]> permutation(int roundsToGo, String[] playedSoFar, ArrayList<String[]> outcomes) {
